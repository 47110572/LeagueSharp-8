...
namespace EverestLib.Tween
{
    ...
    public class Tween<T>
    {
        ...
        private void OnGameUpdate(EventArgs args)
        {
            ...
            this.ElapsedTime += this._stopwatch.ElapsedMilliseconds - this._lastUpdateTime;
            this._lastUpdateTime = this._stopwatch.ElapsedMilliseconds;
        ...
        private void UpdateValue()
        {
            ...
            this.Value = this._lerpFunc(this.StartValue, this.EndValue, this._scaleFunc(this.ElapsedTime / this.Duration));
        }
